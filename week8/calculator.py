...
input_frame = Frame(window, width=80, height=50, bd=0, highlightbackground="black", highlightcolor="black",
                    highlightthickness=1)

input_frame.pack(side=TOP)
input_text = StringVar()
input_field = Entry(input_frame, font=('arial', 18, 'bold'), textvariable=input_text, width=44, bg='#eee', bd=0,
                    justify=RIGHT)
input_field.grid(row=0, column=0)
input_field.pack(ipady=10)

btns_frame = Frame(window, width=500, height=304, bg='grey')
btns_frame.pack()
input_field = Entry()
expression = ''
...
divide = Button(btns_frame, text='/', fg='black', width=10, height=3, bd=0, bg='#FFA500', cursor='hand2',
...
star = Button(btns_frame, text='*', fg='black', width=10, height=3, bd=0, bg='#FFA500', cursor='hand2',
...
six = Button(btns_frame, text='5', fg='black', width=10, height=3, bd=0, bg='#eee', cursor='hand2',
             command=lambda: btn_click('5')).grid(row=2, column=2, padx=1, pady=1)
minus = Button(btns_frame, text='-', fg='black', width=10, height=3, bd=0, bg='#FFA500', cursor='hand2',
...
plus = Button(btns_frame, text='+', fg='black', width=10, height=3, bd=0, bg='#FFA500', cursor='hand2',
              command=lambda: btn_click('+')).grid(row=3, column=3, padx=1, pady=1)

zero = Button(btns_frame, text='0', fg='black', width=21, height=3, bd=0, bg='#eee', cursor='hand2',
              command=lambda: btn_click('0')).grid(row=4, columnspan=2, column=0, padx=1, pady=1)
...
equal = Button(btns_frame, text='=', fg='black', width=10, height=3, bd=0, bg='#FFA500', cursor='hand2',
